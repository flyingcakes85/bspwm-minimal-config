...
echo "https://raw.githubusercontent.com/flyingcakes85/bspwm-minimal-config/main/netinstall.yaml" > /home/liveuser/community_editions/bspwm_netinstall-yaml.url
